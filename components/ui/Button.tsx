  ...
  return (
    <button
      className={clsx(
        ...
        {
          "bg-teal-700 text-white shadow-lg shadow-teal-900/20 hover:-translate-y-0.5 hover:bg-teal-800":
            variant === "primary",
          "bg-white text-slate-900 ring-1 ring-slate-200 hover:bg-slate-100": variant === "secondary",
